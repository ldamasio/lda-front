...
export function NavMenu({ lang, dictionary }: { lang: string, dictionary: Dictionary }) {
  ...
  // Criar array de componentes com verificação segura para evitar acesso a índices inexistentes
  const components = t.portfolio.highlights.map(highlight => {
    return {
      title: highlight.name,
      href: highlight.repositories[0] || '#',
