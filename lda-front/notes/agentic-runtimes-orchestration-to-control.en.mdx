...
description: "Orchestration frameworks give agents capability. Control planes give operators confidence. The gap between them is where production incidents live. A framework for thinking about runtime control in agentic systems."
---
